                ...
                <div class="row row-20 mtn-20">
                    ...
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="images/banner/img1-top.jpg" alt="product banner">
                            </a>
                    ...
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="images/banner/img2-top.jpg" alt="product banner">
                            </a>
                    ...
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="images/banner/img3-top.jpg" alt="product banner">
                            </a>
                            <div class="banner-content text-center">
                    ...
                    <div class="col-sm-6">
                        <figure class="banner-statistics mt-20">
                            <a href="#">
                                <img src="images/banner/img4-top.jpg" alt="product banner">
                            </a>
                            <div class="banner-content text-right">
