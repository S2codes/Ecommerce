...
<head>
  ...
  <title>Subcategories - <?php echo $site_name;?></title>
  <!-- plugins:css -->
...
<body>
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          <div class="container row mb-3">
              <div class="col-md-6">
                <h4>All Subategory</h4>
              </div>
              <div class="col-md-6 text-right">
                <a href='subcategory' class="btn btn-primary mr-2">New Subcategory</a>                
              </div>
          </div>
  ...
  <script>
   $(document).ready(function(){
      //Filter data
      HttpRequest("views/view_subcategories.php","",LoadData);
