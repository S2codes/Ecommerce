...
<head>
  <?php
    if(isset($_GET['edit'])){
      $exists=false;
      $q="SELECT * FROM `manufacturers` WHERE `id`='".$_GET['edit']."' ";
      $DAO = new Database();
      $data=array();
      if($DAO->CountRows($q)){
        $exists=true;
  ...
  <title><?php if($exists) echo $data['name']." - Edit" ; else echo "New";?> Manufacturer - <?php echo $site_name;?></title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          <div class="container row mb-3">
              <div class="col-md-6">
                <h4><?php if($exists) echo "Edit"; else echo "New";?> Manufacturer</h4>
              </div>
                ...
                <div class="card-body">
                  <h4 class="card-title">Category Info</h4>
                    <div class="form-group">
                      <label for="exampleInputUsername1">Manufacturer Name</label>
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Manufacturer Description</label>
  ...
  <script>
   $(document).ready(function(){
     $('#description').summernote({
        placeholder: 'Enter Manufacturer Description Here',
        tabsize: 2,
        height: 120,
        toolbar: [
          ['style', ['style']],
      ...
      $('#form').on('submit',function(e){
          ...
          HttpRequest("scripts/manage_manufacturer.php",form,callback);
      })
