    ...
    <tbody>
        <?php
            foreach($data as $row){
                ...
                echo "
                <tr>
                    <td><a href='coupon?edit=".$row['id']."'>".$row['name']."</a></td>
                    <td><a href='coupon?edit=".$row['id']."'>".$row['code']."</a></td>
                    <td><a href='coupon?edit=".$row['id']."'>".$row['type']."</a></td>
                    <td><a href='coupon?edit=".$row['id']."'>".$row['category']."</a></td>
                    <td><a href='coupon?edit=".$row['id']."'>".$status."</a></td>
                </tr>
                ";
            }
        ?>
