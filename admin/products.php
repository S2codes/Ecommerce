                ...
                <div class="content-wrapper">
                    <div class="container row mb-3">
                        ...
                        <div class="col-md-6 text-right">
                            <a href='product' class="btn btn-primary mr-2">New Product</a>
                        </div>
                    </div>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select id='subcategory' class='form-control'>
                                                    ...
                                                    <?php
                                                        $subcategories=$DAO->RetriveArray("SELECT * FROM `subcategories` ORDER BY `name` ASC ");
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select id='category' class='form-control'>
                                                    ...
                                                    <?php
                                                        $categories=$DAO->RetriveArray("SELECT * FROM `categories` ORDER BY `name` ASC ");
    ...
    <script>
        $(document).ready(function() {
            ...
            function LoadProducts() {
                ...
                HttpRequest("views/view_products.php", form, function(data) {
                    $('.response').html(data);
                });
            }
