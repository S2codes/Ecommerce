...
<head>
  ...
  <title>Manufacturers - <?php echo $site_name;?></title>
  <!-- plugins:css -->
...
<body>
        ...
        <div class="content-wrapper">
          <div class="container row mb-3">
              ...
              <div class="col-md-6 text-right">
                <a href='manufacturer' class="btn btn-primary mr-2">New Manufacturer</a>                
              </div>
          </div>
  ...
  <script>
   $(document).ready(function(){
      //Filter data
      HttpRequest("views/view_manufacturers.php","",LoadData);
