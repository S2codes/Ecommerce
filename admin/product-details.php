                    ...
                    <div class="col-12">
                        <div class="product-carousel-4 slick-row-10 slick-arrow-style">
                            ...
                            <div class="product-item">
                                <figure class="product-thumb">
                                    <a href="product-details.php">
                                        ...
                                        <img class="sec-img" src="images/product/product-16.webp" alt="product">
                                    </a>
                            ...
                            <div class="product-item">
                                <figure class="product-thumb">
                                    <a href="product-details.php">
                                        <img class="pri-img" src="images/product/product-12.webp" alt="product">
                                        <img class="sec-img" src="images/product/product-7.webp" alt="product">
                                    </a>
                                    <div class="product-badge">
                                        <div class="product-label new">
                                            <span>sale</span>
                                ...
                                <div class="product-caption text-center">
                                    <div class="product-identity">
                                        <p class="manufacturer-name"><a href="product-details.php">mony</a></p>
                                    </div>
                                    <ul class="color-categories">
                                        <li>
                                            <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <h6 class="product-name">
                                        <a href="product-details.php">Handmade Golden Necklace</a>
                                    </h6>
                                    <div class="price-box">
                            ...
                            <div class="product-item">
                                <figure class="product-thumb">
                                    <a href="product-details.php">
                                        <img class="pri-img" src="images/product/product-13.webp" alt="product">
                                        <img class="sec-img" src="images/product/product-6.webp" alt="product">
                                    </a>
                                    <div class="product-badge">
                                        <div class="product-label new">
                                            <span>new</span>
                                ...
                                <div class="product-caption text-center">
                                    <div class="product-identity">
                                        <p class="manufacturer-name"><a href="product-details.php">Diamond</a></p>
                                    </div>
                                    <ul class="color-categories">
                                        <li>
                                            <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                            ...
                            <div class="product-item">
                                <figure class="product-thumb">
                                    <a href="product-details.php">
                                        <img class="sec-img" src="images/product/product-5.webp" alt="product">
                                        <img class="pri-img" src="images/product/product-14.webp" alt="product">
                                    </a>
                                    <div class="product-badge">
                                        <div class="product-label new">
                                            <span>sale</span>
                                ...
                                <div class="product-caption text-center">
                                    <div class="product-identity">
                                        <p class="manufacturer-name"><a href="product-details.php">silver</a></p>
                                    </div>
                                    <ul class="color-categories">
                                        <li>
                                            <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <h6 class="product-name">
                                        <a href="product-details.php">Diamond Exclusive Ornament</a>
                                    </h6>
                                    <div class="price-box">
                            ...
                            <div class="product-item">
                                <figure class="product-thumb">
                                    <a href="product-details.php">
                                        <img class="pri-img" src="images/product/product-15.webp" alt="product">
                                        <img class="sec-img" src="images/product/product-4.webp" alt="product">
                                    </a>
                                    <div class="product-badge">
                                        <div class="product-label new">
                                            <span>new</span>
                                ...
                                <div class="product-caption text-center">
                                    ...
                                    <h6 class="product-name">
                                        <a href="product-details.php">Citygold Exclusive Ring</a>
                                    </h6>
                                    <div class="price-box">
                                        <span class="price-regular">$60.00</span>
                                        <span class="price-old"><del>$70.00</del></span>
                    ...
                    <div class="product-details-inner">
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <div class="pro-nav slick-row-10 slick-arrow-style">
                                    <div class="pro-nav-thumb">
                                        <img src="images/product/product-6.webp" alt="product-details" />
                                    </div>
                                    <div class="pro-nav-thumb">
                                        <img src="images/product/product-7.webp" alt="product-details" />
                                    </div>
                                    <div class="pro-nav-thumb">
                                        <img src="images/product/product-1.webp" alt="product-details" />
                                    </div>
                                    <div class="pro-nav-thumb">
                                        <img src="images/product/product-8.webp" alt="product-details" />
                                    </div>
                                    <div class="pro-nav-thumb">
                                        <img src="images/product/product-9.webp" alt="product-details" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-7">
